...
import 'PlayerGameWinner.dart';

export 'Game.dart';
export 'GameWinner.dart';
export 'Player.dart';
export 'PlayerGame.dart';
export 'PlayerGameWinner.dart';
...
class ModelProvider implements ModelProviderInterface {
  ...
  ModelType getModelTypeByModelName(String modelName) {
    switch(modelName) {
      ...
      case "GameWinner":
        return GameWinner.classType;
      case "Player":
        return Player.classType;
      case "PlayerGame":
        return PlayerGame.classType;
      case "PlayerGameWinner":
        return PlayerGameWinner.classType;
      default:
